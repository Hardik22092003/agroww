  ...
  return (
    <div className="font-sans">
      <section className="relative w-full h-[75vh]">
        <img src="/hero.jpg" alt="Hero Agroww" className="absolute inset-0 w-full h-full object-cover brightness-75" />
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-6 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-lg">Empowering Farmers with Technology</h1>
        </div>
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white text-center px-4">
          <p className="text-lg md:text-xl drop-shadow-md max-w-3xl">Revolutionizing agriculture by connecting farmers and investors through land sharing, technology, and trust.</p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-16 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-center hover:shadow-xl transition">
            <img src="/landshare.jpg" alt="Land Share Trading" className="w-full h-40 object-cover rounded-md mb-4" />
            <h3 className="text-xl font-bold mb-2 text-emerald-700">Land Share Trading</h3>
            <p className="text-gray-600">Farmers can list their land and sell fractional shares to verified investors, just like stocks.</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-center hover:shadow-xl transition">
            <img src="/verify.jpg" alt="Admin Verification" className="w-full h-40 object-cover rounded-md mb-4" />
            <h3 className="text-xl font-bold mb-2 text-emerald-700">Admin Verification</h3>
            <p className="text-gray-600">Secure and transparent system to verify land details, farmer identities, and investor profiles.</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-center hover:shadow-xl transition">
            <img src="/smartfarming.jpg" alt="AI Tools" className="w-full h-40 object-cover rounded-md mb-4" />
            <h3 className="text-xl font-bold mb-2 text-emerald-700">Investor Farmer MarketPlace</h3>
            <p className="text-gray-600">Investors browse verified land listings, assess location, soil type, crops and they can invest in multiple lands as per interest and budget.</p>
          </div>
        </div>
      </section>
    </div>
