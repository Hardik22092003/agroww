...
import { FiMail, FiLock, FiEye, FiEyeOff, FiTrendingUp, FiDollarSign, FiBarChart2 } from 'react-icons/fi';
...
const InvestorLogin = () => {
  ...
  const handleOAuthLogin = (provider) => {
    window.location.href = `http://localhost:5000/auth/${provider}?role=investor`;
  };
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 via-indigo-50 to-teal-50">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 text-white/15"><FiBarChart2 className="w-24 h-24" /></div>
